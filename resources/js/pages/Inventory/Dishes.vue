      ...
      <nav class="glass-effect m-4 rounded-2xl shadow-2xl flex flex-col transition-all duration-300 overflow-hidden" :class="sidebarOpen ? 'w-64' : 'w-20'">
        ...
        <div class="px-2">
          <ul class="mt-1 space-y-1">
            ...
            <li><a href="/inventory/combos" class="flex items-center gap-3 rounded-xl px-3 py-2 transition-colors text-gray-700 hover:bg-orange-50"><i class="fas fa-layer-group text-lg text-gray-600"></i><span v-if="sidebarOpen" class="font-medium">Combos</span></a></li>
