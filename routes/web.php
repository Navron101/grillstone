...
Route::middleware('auth')->group(function () {
    ...
    // Inventory (UI) - requires Inventory module access
    Route::middleware('module:Inventory')->group(function () {
        ...
        Route::get('/inventory/combos', fn () => Inertia::render('Inventory/Combos'))->name('inventory.combos');
    ...
    // HR & Payroll - requires HR module access
    ...
    // Loyalty Program - requires Loyalty module access
    ...
    // Till Settlements - requires Finance module access
